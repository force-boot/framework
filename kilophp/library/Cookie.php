...
class Cookie
{
     ...
     * @return void
     */
    public static function set(string $name, $value = '', $option = null)
    {
     ...
     * @return void
     */
    public static function forever(string $name, $value = '', $option = null)
    {
     ...
     * @return bool
     */
    public static function has(string $name, string $prefix = null)
    {
        !isset(self::$init) && self::init();
